...
function AdminUsers() {
  ...
  return <div className="space-y-4">
    ...
    <Card><h2 className="mb-3 font-semibold">Usuarios</h2><Table rows={overview.data?.data ?? []} columns={['id', 'name', 'email', 'is_admin', 'active_api_tokens_count', 'requests_today_count', 'requests_total_count', 'created_at']} /></Card>
