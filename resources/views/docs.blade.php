...
<body class="bg-white text-zinc-950">
        ...
        <section class="mx-auto grid max-w-7xl gap-8 px-6 py-12 lg:grid-cols-[260px_1fr] lg:px-8">
            ...
            <div class="space-y-10">
                <section id="auth" class="rounded border border-zinc-200 p-6">
                    ...
                    <div class="mt-4 grid gap-3 md:grid-cols-2">
                        <div class="rounded bg-zinc-100 p-4">
                            ...
                            <code class="mt-2 block overflow-x-auto rounded bg-white p-3 text-sm">Authorization: Bearer sua_chave</code>
                        </div>
                        <div class="rounded bg-zinc-100 p-4">
                            <p class="font-bold">Header alternativo</p>
                ...
                <section id="quickstart" class="rounded border border-zinc-200 p-6">
                    ...
                    <p class="mt-3 text-zinc-600">A API responde em JSON. Inclua sua chave em todas as chamadas.</p>
                    <pre class="mt-4 overflow-x-auto rounded bg-zinc-950 p-4 text-sm text-emerald-100"><code>curl "{{ $baseUrl }}/metadata" \
  -H "Authorization: Bearer sua_chave"</code></pre>
  ...
  .then(data => console.log(data.data));</code></pre>
                ...
                <section id="pagination" class="rounded border border-zinc-200 p-6">
                    ...
                    <pre class="mt-4 overflow-x-auto rounded bg-zinc-950 p-4 text-sm text-emerald-100"><code>GET {{ $baseUrl }}/teams?page=2
Authorization: Bearer sua_chave</code></pre>
                ...
                <section id="examples" class="rounded border border-zinc-200 p-6">
                    ...
                    <div class="mt-5 space-y-5">
                        <div>
                            ...
                            <pre class="mt-2 overflow-x-auto rounded bg-zinc-950 p-4 text-sm text-emerald-100"><code>GET {{ $baseUrl }}/leagues?active=1
Authorization: Bearer sua_chave</code></pre>
                        </div>

                        <div>
                            <h3 class="font-bold">Buscar partidas finalizadas de uma liga em um periodo</h3>
                            <pre class="mt-2 overflow-x-auto rounded bg-zinc-950 p-4 text-sm text-emerald-100"><code>GET {{ $baseUrl }}/matches?league_id=1&status=finished&date_from=2026-01-01&date_to=2026-12-31
Authorization: Bearer sua_chave</code></pre>
                        </div>

                        <div>
                            <h3 class="font-bold">Buscar partidas de um time</h3>
                            <pre class="mt-2 overflow-x-auto rounded bg-zinc-950 p-4 text-sm text-emerald-100"><code>GET {{ $baseUrl }}/matches?team_id=10
Authorization: Bearer sua_chave</code></pre>
                        </div>

                        <div>
                            <h3 class="font-bold">Buscar classificacao de uma temporada</h3>
                            <pre class="mt-2 overflow-x-auto rounded bg-zinc-950 p-4 text-sm text-emerald-100"><code>GET {{ $baseUrl }}/standings?league_id=1&season_id=1
Authorization: Bearer sua_chave</code></pre>
                        </div>
                        ...
                        <div>
                            ...
                            <pre class="mt-2 overflow-x-auto rounded bg-zinc-950 p-4 text-sm text-emerald-100"><code>GET {{ $baseUrl }}/teams?updated_since=2026-06-01
Authorization: Bearer sua_chave</code></pre>
                        </div>
                    </div>
                </section>
