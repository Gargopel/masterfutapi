...
class SiteSetting extends Model
{
    ...
    public static function homepageDefaults(): array
    {
        return [
            ...
            'nav_badge' => 'Football data infrastructure',
            'hero_title' => 'Dados de futebol prontos para produtos, dashboards e automacoes.',
            'hero_subtitle' => 'Uma API esportiva com coletas por provedores, historico de partidas, standings, times, ligas e observabilidade operacional para crescer com seguranca.',
            ...
            'accent_color' => '#16a34a',
            'features' => [
                ['title' => 'Multi-provider', 'description' => 'Football-Data.org, API-Football e novos conectores em uma camada unica.'],
                ['title' => 'Sync operacional', 'description' => 'Jobs, progresso, logs externos, retries, schedules, alertas e exports CSV.'],
