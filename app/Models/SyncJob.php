...
{
    use HasFactory;
    protected $fillable = ['parent_sync_job_id', 'sync_schedule_id', 'api_provider_id', 'sport_id', 'league_id', 'season_id', 'type', 'source', 'is_incremental', 'status', 'progress_percent', 'total_items', 'processed_items', 'created_items', 'updated_items', 'failed_items', 'started_at', 'finished_at', 'cancel_requested_at', 'last_error', 'config', 'result'];
    protected $casts = ['is_incremental' => 'boolean', 'progress_percent' => 'decimal:2', 'started_at' => 'datetime', 'finished_at' => 'datetime', 'cancel_requested_at' => 'datetime', 'config' => 'array', 'result' => 'array'];
