...
class ObservabilityTest extends TestCase
{
    ...
    public function test_data_coverage_provider_health_and_metadata(): void
    {
        ...
        $this->getJson('/api/v1/metadata')->assertOk()->assertJsonPath('api_version', 'v1')->assertJsonPath('supported_languages.0', 'pt-BR');
    }
    ...
    public function test_retry_pagination_cooldown_schedules_csv_and_updated_since(): void
    {
        ...
        $this->getJson('/api/v1/leagues?updated_since=2000-01-01T00:00:00')->assertOk()->assertJsonFragment(['current_page' => 1]);
    }
